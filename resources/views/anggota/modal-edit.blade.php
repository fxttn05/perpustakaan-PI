<div id="editModal" class="hidden fixed inset-0 bg-black/50 z-50 items-center justify-center">
    <div class="bg-white rounded-xl w-full max-w-4xl">
        ...
        <div class="flex justify-between items-center border-b p-5">
            <h2 class="text-xl font-semibold">Form Edit Anggota</h2>
        ...
        <form id="formEdit" method="POST">
            ...
            <div class="grid grid-cols-2 gap-5 p-6">
                <div>
                    <label class="block mb-2">Kode Anggota</label>
                    <input id="edit_kode" readonly class="w-full border rounded-lg p-2 bg-slate-100">
                </div>

                <div>
                    <label class="block mb-2">Nama Lengkap</label>
                    <input type="text" id="edit_nama" name="nama_lengkap" class="w-full border rounded-lg p-2">
                </div>

                <div>
                    <label class="block mb-2">Jabatan</label>
                    <select id="edit_jabatan" name="jabatan" class="w-full border rounded-lg p-2">
                        <option value="Siswa">
                            Siswa
                        </option>
                        <option value="Guru">
                ...
                <div>
                    ...
                    <input type="text" id="edit_kelas" name="kelas" class="w-full border rounded-lg p-2">
                </div>

                <div>
                    <label class="block mb-2">Email</label>
                    <input type="email" id="edit_email" name="email" class="w-full border rounded-lg p-2">
                </div>
