...
<div id="anggota_result" class="hidden absolute left-0 right-0 bg-white border rounded-lg shadow-lg mt-1 max-h-60 overflow-y-auto z-50"></div>
...
<input
type="text"
class="buku-search w-full border rounded-lg p-2"
placeholder="Cari kode / judul buku">

<div class="hidden buku-result absolute left-0 right-0 bg-white border rounded-lg shadow-lg mt-1 max-h-60 overflow-y-auto z-40"></div>
...
<button
type="button"
class="hapusBaris bg-red-500 text-white rounded-lg w-full h-full">
...
<button
type="button"
onclick="confirmSave('formTambah')"
